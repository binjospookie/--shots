  ...
  return function (root, result) {
    ...
    root.walkDecls(/^font(-family)?$/i, function (decl) {
      ...
      fontFamilies.forEach(function (fontFamilyNode) {
        var rawFamily = fontFamilyNode.value;
    ...
    function checkFamilyName(rawFamily, decl) {
      if (!(0, _utils.isStandardSyntaxValue)(rawFamily)) {
        return;
      }
      ...
      var hasQuotes = rawFamily[0] === "'" || rawFamily[0] === "\"";
      ...
      if (_keywordSets.fontFamilyKeywords.has(family.toLowerCase()) || isSystemFontKeyword(family)) {
        if (hasQuotes) {
...
var messages = exports.messages = (0, _utils.ruleMessages)(ruleName, {
  expected: function expected(family) {
    return "Expected quotes around \"" + family + "\"";
  },
  rejected: function rejected(family) {
    return "Unexpected quotes around \"" + family + "\"";
  }
});
