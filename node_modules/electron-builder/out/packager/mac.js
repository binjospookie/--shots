...
let createApp = exports.createApp = (() => {
    var _ref = (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* (packager, appOutDir, initializeApp) {
        ...
        if (icon != null) {
            promises.push((0, (_fsExtraP || _load_fsExtraP()).unlink)(_path.join(contentsPath, "Resources", oldIcon)));
            promises.push((0, (_fsExtraP || _load_fsExtraP()).copy)(icon, _path.join(contentsPath, "Resources", appPlist.CFBundleIconFile)));
        }
